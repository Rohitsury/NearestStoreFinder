        ...
        <div className="loginDiv container d-flex justify-content-center">
          <div className="row loginRow ">
            <div className="col-12 col-lg-6 col-md-6">
              ...
              <div className="p-lg-5">
                ...
                <div className="text-center text-lg-start">
                  ...
                  <Link to="/register" className="btn signupButton">
                    Sign up
                  </Link>
                </div>
              </div>
            ...
            <div className="col-12 col-lg-6 col-md-6 d-flex justify-content-center align-items-center p-lg-5 p-0 pt-lg-0 ">
              {!modal ? (
                <form
                  className="loginForm w-75 p-lg-5 p-3"
                ...
                >
                  ...
                  <button type="submit" className=" loginButton py-2">
                    Sign in
                  </button>
                  <Link
                    onClick={() => setModal(true)}
                    className="d-block mt-2 forgotPasswordText"
                  >
                    Forgot Password ?
                  </Link>
                </form>
